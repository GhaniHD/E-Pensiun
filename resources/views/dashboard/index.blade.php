        ...
        <div class="card-body py-3 px-4 d-flex align-items-center justify-content-between flex-wrap gap-2">
            <div>
                ...
                <div style="font-size:0.85rem;opacity:.85">
                    ...
                    @if(auth()->user()->office) — {{ auth()->user()->office }} @endif
        ...
        <div class="card-body py-3">
            ...
            <div class="progress" style="height:10px;border-radius:99px">
                <div class="progress-bar" role="progressbar"
                    ...
                    aria-valuenow="{{ $stats['percentCompleted'] }}" aria-valuemin="0" aria-valuemax="100">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body d-flex flex-column gap-2">
                    @if(auth()->user()->isPensiunan() || auth()->user()->isSdmKantor())
                        <a href="{{ route('applications.create') }}" class="btn btn-primary d-flex align-items-center gap-2">
...
@section('scripts')
    <script>
        ...
        @if(count($officeData) > 0)
            const officeColors = [
                '#1B4F72', '#2E86C1', '#1E8449', '#D4AC0D', '#C0392B',
                '#7D3C98', '#1A5276', '#117A65', '#B7950B', '#922B21'
            ];
